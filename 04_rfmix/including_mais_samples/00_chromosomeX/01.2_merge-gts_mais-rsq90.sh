...
workdir=./opgen/04_rfmix/including_mais_samples/00_chromosomeX/

datadir1=$workdir/mais_affy/geno_files
datadir2=$workdir/mais_omni/geno_files

mkdir $workdir/merged_mais
mergedir=$workdir/merged_mais

name1='mais_affy.rsq90.biallelic'
name2='mais_omni.rsq90.biallelic'

python $workdir/01.1_remove-indels.py
