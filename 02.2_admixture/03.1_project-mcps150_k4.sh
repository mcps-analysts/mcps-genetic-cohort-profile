...
#$ -N K_4-mcps150k-project-admix
#$ -q long.qc
#$ -o popgen/02.2_admixture/afr_eas_eur_mais_amr-select-mcps1k/logs/mcps150k-project-admix_k4.out
#$ -e popgen/02.2_admixture/afr_eas_eur_mais_amr-select-mcps1k/logs/mcps150k-project-admix_k4.err
#$ -pe shmem 24
