#!/bin/bash
#$ -cwd
#$ -N MT_IMPUTE5_MCPS_60K_chr12q
#$ -q short.qc@@short.hga
#$ -pe shmem 44
#$ -o ./pop_structure/code/IMPUTE5/60K_analyses/logs/MT_IMPUTE5_60K_12q.out
#$ -e ./pop_structure/code/IMPUTE5/60K_analyses/logs/MT_IMPUTE5_60K_12q.err
...
echo "-----------------------------------------"
	...
	##This script tries to run IMPUTE5 on chr12q to create a co-ancestry matrix##
...
--g $input_folder/MT_MCPS_60K_phased_MAF1pc_no_ambigs_chr$chr.vcf.gz --r $chr:35000001-133300000 \
