...
#$ -cwd
#$ -P emberson.prjc
#$ -N MT_IMPUTE5_MCPS_60K_chr3p
#$ -q long.qc
#$ -pe shmem 44
#$ -o ./pop_structure/code/IMPUTE5/60K_analyses/logs/MT_IMPUTE5_60K_3p.out
#$ -e ./pop_structure/code/IMPUTE5/60K_analyses/logs/MT_IMPUTE5_60K_3p.err
...
echo "-----------------------------------------"
	...
	##This script tries to run IMPUTE5 on all chr3p to create a co-ancestry matrix##
