#!/bin/bash
#$ -cwd
#$ -N MT_IMPUTE5_MCPS_60K_chr7p
#$ -q long.qc
#$ -pe shmem 44
#$ -o ./pop_structure/code/IMPUTE5/60K_analyses/logs/MT_IMPUTE5_60K_7p.out
#$ -e ./pop_structure/code/IMPUTE5/60K_analyses/logs/MT_IMPUTE5_60K_7p.err
...
echo "-----------------------------------------"
	...
	##This script tries to run IMPUTE5 on chr7p to create a co-ancestry matrix##
