#!/bin/bash
#$ -cwd
#$ -N MT_IMPUTE5_MCPS_60K_chr5qii
#$ -q long.qc
#$ -pe shmem 44
#$ -o ./pop_structure/code/IMPUTE5/60K_analyses/logs/MT_IMPUTE5_60K_5qii.out
#$ -e ./pop_structure/code/IMPUTE5/60K_analyses/logs/MT_IMPUTE5_60K_5qii.err
...
echo "-----------------------------------------"
	...
	##This script tries to run IMPUTE5 on chr5q to create a co-ancestry matrix##
...
--g $input_folder/MT_MCPS_60K_phased_MAF1pc_no_ambigs_chr$chr.vcf.gz --r $chr:72000001-181600000 \
