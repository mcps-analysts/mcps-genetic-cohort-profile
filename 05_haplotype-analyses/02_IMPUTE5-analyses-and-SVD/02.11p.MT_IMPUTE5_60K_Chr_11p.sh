#!/bin/bash
#$ -cwd
#$ -N MT_IMPUTE5_MCPS_60K_chr11p
#$ -q short.qc@@short.hga
#$ -pe shmem 44
#$ -o ./pop_structure/code/IMPUTE5/60K_analyses/logs/MT_IMPUTE5_60K_11p.out
#$ -e ./pop_structure/code/IMPUTE5/60K_analyses/logs/MT_IMPUTE5_60K_11p.err
...
echo "-----------------------------------------"
	...
	##This script tries to run IMPUTE5 on chr11p to create a co-ancestry matrix##
