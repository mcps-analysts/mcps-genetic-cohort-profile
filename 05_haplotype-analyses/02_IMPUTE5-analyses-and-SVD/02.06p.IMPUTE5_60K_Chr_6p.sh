...
#$ -q himem.qh
#$ -pe shmem 24
#$ -o ./pop_structure/code/IMPUTE5/60K_analyses/logs/MT_IMPUTE5_60K_6p.out
#$ -e ./pop_structure/code/IMPUTE5/60K_analyses/logs/MT_IMPUTE5_60K_6p.err
...
echo "-----------------------------------------"
	...
	##This script tries to run IMPUTE5 on chr6p to create a co-ancestry matrix##
