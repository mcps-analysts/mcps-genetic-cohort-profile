#!/bin/bash
#$ -cwd
#$ -N MT_IMPUTE5_MCPS_60K_chr8p
#$ -q short.qc@@short.hga
#$ -pe shmem 44
#$ -o ./pop_structure/code/IMPUTE5/60K_analyses/logs/MT_IMPUTE5_60K_8p.out
#$ -e ./pop_structure/code/IMPUTE5/60K_analyses/logs/MT_IMPUTE5_60K_8p.err
...
echo "-----------------------------------------"
	...
	##This script tries to run IMPUTE5 on chr8p to create a co-ancestry matrix##
...
--g $input_folder/MT_MCPS_60K_phased_MAF1pc_no_ambigs_chr$chr.vcf.gz --r $chr:1-45000000 \
