...
"Choosing K
We run the algorithm over a range of K with multiple reps for each value of K. Then, 
we extract the final validation likelihood for each run. Averaging over all reps, we choose 
the value of K where the validation likelihood plateaus."
