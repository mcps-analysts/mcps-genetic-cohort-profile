...
#$ -cwd
#$ -P emberson.prjc
#$ -N MT_IMPUTE5_MCPS_60K_chr15q
#$ -q short.qc@@short.hga
#$ -pe shmem 40
#$ -o ./pop_structure/code/IMPUTE5/60K_analyses/logs/MT_IMPUTE5_60K_15q.out
#$ -e ./pop_structure/code/IMPUTE5/60K_analyses/logs/MT_IMPUTE5_60K_15q.err
...
--g $input_folder/MT_MCPS_60K_phased_MAF1pc_no_ambigs_chr$chr.vcf.gz --r $chr:65000001-102000000 \
