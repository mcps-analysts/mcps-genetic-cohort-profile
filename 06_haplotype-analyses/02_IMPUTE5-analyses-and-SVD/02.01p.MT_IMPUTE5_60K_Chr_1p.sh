...
#$ -q long.qc
#$ -pe shmem 44
#$ -o ./code/IMPUTE5/60K_analyses/logs/MT_IMPUTE5_60K_1pii.out
#$ -e ./code/IMPUTE5/60K_analyses/logs/MT_IMPUTE5_60K_1pii.err
...
echo "-----------------------------------------"
	...
	##This script tries to run IMPUTE5 on all 22 autosomes to create 22 co-ancestry matrices##
